...
import { genereateProgressPercentage } from "../utils/generate-progress-percentage";
import dayjs from "dayjs";

const WEEK_DAYS = 7;
const SCREEN_HORIZONTAL__PADDING = (32*2)/5

export const DAY_MARGIN_BETWEEN = 8;
export const DAY_SIZE = (Dimensions.get('screen').width / WEEK_DAYS) - (SCREEN_HORIZONTAL__PADDING + 5)
...
export function HabitDay({ amountOfHabits = 0, amountCompleted = 0, date, ...rest }: Props) {
    ...
    const amountAccomplishedPercentage = amountOfHabits > 0 ? genereateProgressPercentage(amountOfHabits, amountCompleted) : 0
