...
export function NewHabitForm(){
    ...
    return(
        <form onSubmit={createNewHabit} className="w-full flex flex-col mt-6">
            ...
            <button type="submit" className="mt-6 rounded-lg p-4 gap-3 flex items-center font-semibold bg-green-600 justify-center hover:bg-green-500 transition-colors focus: outline-none focus:ring-2 focus:ring-green-700 focus:ring-offset-2 focus:ring-offset-zinc-900" >
